/* Header file generated from BLE.xml */
...
Public macros
==================================================================================================*/
#define L2CAP_COMMANDS_ENABLE TRUE
#define GATT_COMMANDS_ENABLE TRUE
#define GATT_DATABASE_APPLICATION_COMMANDS_ENABLE TRUE
#define GAP_COMMANDS_ENABLE TRUE
#define FSCI_COMMANDS_ENABLE TRUE
#define FSCI_EVENTS_ENABLE TRUE
#define L2CAP_EVENTS_ENABLE TRUE
#define GATT_EVENTS_ENABLE TRUE
#define GATT_DATABASE_APPLICATION_EVENTS_ENABLE TRUE
#define GAP_EVENTS_ENABLE TRUE
...
typedef PACKED_STRUCT L2CAPRegisterLePsmRequest_tag {
	uint16_t LePsm;  // Bluetooth SIG or Vendor LE_PSM
	uint16_t LePsmMtu;  // MTU value
} L2CAPRegisterLePsmRequest_t;

typedef PACKED_STRUCT L2CAPDeregisterLePsmRequest_tag {
	uint16_t LePsm;  // Bluetooth SIG or Vendor LE_PSM
} L2CAPDeregisterLePsmRequest_t;

typedef PACKED_STRUCT L2CAPConnectLePsmRequest_tag {
	uint16_t LePsm;  // Bluetooth SIG or Vendor LE_PSM
	uint8_t DeviceId;  // The DeviceId for which the command is intended
	uint16_t InitialCredits;  // Initial credits
} L2CAPConnectLePsmRequest_t;

typedef PACKED_STRUCT L2CAPDisconnectLeCbChannelRequest_tag {
	uint8_t DeviceId;  // The DeviceId for which the command is intended
	uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
} L2CAPDisconnectLeCbChannelRequest_t;

/* Refuse reason */
typedef enum L2CAPCancelConnectionRequest_RefuseReason_tag {
	L2CAPCancelConnectionRequest_RefuseReason_gSuccessful_c = 0x0000,
	L2CAPCancelConnectionRequest_RefuseReason_gLePsmNotSupported_c = 0x0002,
	L2CAPCancelConnectionRequest_RefuseReason_gNoResourcesAvailable_c = 0x0004,
	L2CAPCancelConnectionRequest_RefuseReason_gInsufficientAuthentication_c = 0x0005,
	L2CAPCancelConnectionRequest_RefuseReason_gInsufficientAuthorization_c = 0x0006,
	L2CAPCancelConnectionRequest_RefuseReason_gInsufficientEncryptionKeySize_c = 0x0007,
	L2CAPCancelConnectionRequest_RefuseReason_gInsufficientEncryption_c = 0x0008,
	L2CAPCancelConnectionRequest_RefuseReason_gInvalidSourceCid_c = 0x0009,
	L2CAPCancelConnectionRequest_RefuseReason_gSourceCidAlreadyAllocated_c = 0x000A,
	L2CAPCancelConnectionRequest_RefuseReason_gCommandRejected_c = 0x0100,
	L2CAPCancelConnectionRequest_RefuseReason_gResponseTimeout_c = 0xFFFE
} L2CAPCancelConnectionRequest_RefuseReason_t;

typedef PACKED_STRUCT L2CAPCancelConnectionRequest_tag {
	uint16_t LePsm;  // Bluetooth SIG or Vendor LE_PSM
	uint8_t DeviceId;  // The DeviceId for which the command is intended
	L2CAPCancelConnectionRequest_RefuseReason_t RefuseReason;  // Refuse reason
} L2CAPCancelConnectionRequest_t;

typedef struct L2CAPSendLeCbDataRequest_tag {
	uint8_t DeviceId;  // The DeviceId for which the command is intended
	uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
	uint16_t PacketLength;  // Length of the data packet to be sent
	uint8_t *Packet;  // The data packet to be transmitted
} L2CAPSendLeCbDataRequest_t;

typedef PACKED_STRUCT L2CAPSendLeCreditRequest_tag {
	uint8_t DeviceId;  // The DeviceID to which credits are given
	uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
	uint16_t Credits;  // Number of credits to be given
} L2CAPSendLeCreditRequest_t;
...
typedef struct GATTServerRegisterHandlesForWriteNotificationsRequest_tag {
	...
	uint8_t *AttributeHandles;  // Statically allocated array of handles
...
typedef struct GATTDBDynamicAddCharacteristicDeclarationAndValueRequest_tag {
	...
	uint8_t CharacteristicProperties;  // Characteristic properties
...
/* Bit mask indicating which of the three advertising channels will be used - default all three */
typedef enum GAPSetAdvertisingParametersRequest_ChannelMap_tag {
	GAPSetAdvertisingParametersRequest_ChannelMap_gChannel37_c = 0x01,
	GAPSetAdvertisingParametersRequest_ChannelMap_gChannel38_c = 0x02,
	GAPSetAdvertisingParametersRequest_ChannelMap_gChannel39_c = 0x04
} GAPSetAdvertisingParametersRequest_ChannelMap_t;
...
typedef PACKED_STRUCT GAPSetAdvertisingParametersRequest_tag {
	...
	uint8_t ChannelMap;  // Bit mask indicating which of the three advertising channels will be used - default all three
...
typedef PACKED_STRUCT GAPGetBondedStaticAddressesRequest_tag {
	uint8_t MaxNbOfDevices;  // Maximum number of addresses to be obtained
} GAPGetBondedStaticAddressesRequest_t;
...
/* The level of security requested */
typedef enum GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_tag {
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode1Level1_c = 0x10,
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode1Level2_c = 0x11,
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode1Level3_c = 0x12,
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode1Level4_c = 0x13,
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode2Level1_c = 0x21,
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_gMode2Level2_c = 0x22
} GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_t;

typedef PACKED_STRUCT GAPSendSlaveSecurityRequestRequest_tag {
	uint8_t DeviceId;  // The GAP peer to pair with
	bool_t BondAfterPairing;  // Specifies if bonding is supported
	GAPSendSlaveSecurityRequestRequest_SecurityModeLevel_t SecurityModeLevel;  // The level of security requested
...
typedef PACKED_STRUCT GAPLeScSendKeypressNotificationPrivacyRequest_tag {
	uint8_t DeviceId;  // The DeviceID for which the command is intended
	GAPLeScSendKeypressNotificationPrivacyRequest_GapLeScKeypressNotificationParams_keypressNotifType_t GapLeScKeypressNotificationParams_keypressNotifType;  // Keypress notification type which denotes a passkey entry keypress action
...
typedef enum L2CAPConfirm_Status_tag {
	L2CAPConfirm_Status_gBleSuccess_c = 0x0000,
	L2CAPConfirm_Status_gBleInvalidParameter_c = 0x0001,
	L2CAPConfirm_Status_gBleOverflow_c = 0x0002,
	L2CAPConfirm_Status_gBleUnavailable_c = 0x0003,
	L2CAPConfirm_Status_gBleFeatureNotSupported_c = 0x0004,
	L2CAPConfirm_Status_gBleOutOfMemory_c = 0x0005,
	L2CAPConfirm_Status_gBleAlreadyInitialized_c = 0x0006,
	L2CAPConfirm_Status_gBleOsError_c = 0x0007,
	L2CAPConfirm_Status_gBleUnexpectedError_c = 0x0008,
	L2CAPConfirm_Status_gBleInvalidState_c = 0x0009,
	L2CAPConfirm_Status_gHciUnknownHciCommand_c = 0x0101,
	L2CAPConfirm_Status_gHciUnknownConnectionIdentifier_c = 0x0102,
	L2CAPConfirm_Status_gHciHardwareFailure_c = 0x0103,
	L2CAPConfirm_Status_gHciPageTimeout_c = 0x0104,
	L2CAPConfirm_Status_gHciAuthenticationFailure_c = 0x0105,
	L2CAPConfirm_Status_gHciPinOrKeyMissing_c = 0x0106,
	L2CAPConfirm_Status_gHciMemoryCapacityExceeded_c = 0x0107,
	L2CAPConfirm_Status_gHciConnectionTimeout_c = 0x0108,
	L2CAPConfirm_Status_gHciConnectionLimitExceeded_c = 0x0109,
	L2CAPConfirm_Status_gHciSynchronousConnectionLimitToADeviceExceeded_c = 0x010A,
	L2CAPConfirm_Status_gHciAclConnectionAlreadyExists_c = 0x010B,
	L2CAPConfirm_Status_gHciCommandDisallowed_c = 0x010C,
	L2CAPConfirm_Status_gHciConnectionRejectedDueToLimitedResources_c = 0x010D,
	L2CAPConfirm_Status_gHciConnectionRejectedDueToSecurityReasons_c = 0x010E,
	L2CAPConfirm_Status_gHciConnectionRejectedDueToUnacceptableBdAddr_c = 0x010F,
	L2CAPConfirm_Status_gHciConnectionAcceptTimeoutExceeded_c = 0x0110,
	L2CAPConfirm_Status_gHciUnsupportedFeatureOrParameterValue_c = 0x0111,
	L2CAPConfirm_Status_gHciInvalidHciCommandParameters_c = 0x0112,
	L2CAPConfirm_Status_gHciRemoteUserTerminatedConnection_c = 0x0113,
	L2CAPConfirm_Status_gHciRemoteDeviceTerminatedConnectionLowResources_c = 0x0114,
	L2CAPConfirm_Status_gHciRemoteDeviceTerminatedConnectionPowerOff_c = 0x0115,
	L2CAPConfirm_Status_gHciConnectionTerminatedByLocalHost_c = 0x0116,
	L2CAPConfirm_Status_gHciRepeatedAttempts_c = 0x0117,
	L2CAPConfirm_Status_gHciPairingNotAllowed_c = 0x0118,
	L2CAPConfirm_Status_gHciUnknownLpmPdu_c = 0x0119,
	L2CAPConfirm_Status_gHciUnsupportedRemoteFeature_c = 0x011A,
	L2CAPConfirm_Status_gHciScoOffsetRejected_c = 0x011B,
	L2CAPConfirm_Status_gHciScoIntervalRejected_c = 0x011C,
	L2CAPConfirm_Status_gHciScoAirModeRejected_c = 0x011D,
	L2CAPConfirm_Status_gHciInvalidLpmParameters_c = 0x011E,
	L2CAPConfirm_Status_gHciUnspecifiedError_c = 0x011F,
	L2CAPConfirm_Status_gHciUnsupportedLpmParameterValue_c = 0x0120,
	L2CAPConfirm_Status_gHciRoleChangeNotAllowed_c = 0x0121,
	L2CAPConfirm_Status_gHciLLResponseTimeout_c = 0x0122,
	L2CAPConfirm_Status_gHciLmpErrorTransactionCollision_c = 0x0123,
	L2CAPConfirm_Status_gHciLmpPduNotAllowed_c = 0x0124,
	L2CAPConfirm_Status_gHciEncryptionModeNotAcceptable_c = 0x0125,
	L2CAPConfirm_Status_gHciLinkKeyCannotBeChanged_c = 0x0126,
	L2CAPConfirm_Status_gHciRequestedQosNotSupported_c = 0x0127,
	L2CAPConfirm_Status_gHciInstantPassed_c = 0x0128,
	L2CAPConfirm_Status_gHciPairingWithUnitKeyNotSupported_c = 0x0129,
	L2CAPConfirm_Status_gHciDifferentTransactionCollision_c = 0x012A,
	L2CAPConfirm_Status_gHciReserved_0x2B_c = 0x012B,
	L2CAPConfirm_Status_gHciQosNotAcceptableParameter_c = 0x012C,
	L2CAPConfirm_Status_gHciQosRejected_c = 0x012D,
	L2CAPConfirm_Status_gHciChannelClassificationNotSupported_c = 0x012E,
	L2CAPConfirm_Status_gHciInsufficientSecurity_c = 0x012F,
	L2CAPConfirm_Status_gHciParameterOutOfMandatoryRange_c = 0x0130,
	L2CAPConfirm_Status_gHciReserved_0x31_c = 0x0131,
	L2CAPConfirm_Status_gHciRoleSwitchPending_c = 0x0132,
	L2CAPConfirm_Status_gHciReserved_0x33_c = 0x0133,
	L2CAPConfirm_Status_gHciReservedSlotViolation_c = 0x0134,
	L2CAPConfirm_Status_gHciRoleSwitchFailed_c = 0x0135,
	L2CAPConfirm_Status_gHciExtendedInquiryResponseTooLarge_c = 0x0136,
	L2CAPConfirm_Status_gHciSecureSimplePairingNotSupportedByHost_c = 0x0137,
	L2CAPConfirm_Status_gHciHostBusyPairing_c = 0x0138,
	L2CAPConfirm_Status_gHciConnectionRejectedDueToNoSuitableChannelFound_c = 0x0139,
	L2CAPConfirm_Status_gHciControllerBusy_c = 0x013A,
	L2CAPConfirm_Status_gHciUnacceptableConnectionParameters_c = 0x013B,
	L2CAPConfirm_Status_gHciDirectedAdvertisingTimeout_c = 0x013C,
	L2CAPConfirm_Status_gHciConnectionTerminatedDueToMicFailure_c = 0x013D,
	L2CAPConfirm_Status_gHciConnectionFailedToBeEstablished_c = 0x013E,
	L2CAPConfirm_Status_gHciMacConnectionFailed_c = 0x013F,
	L2CAPConfirm_Status_gHciCoarseClockAdjustmentRejected_c = 0x0140,
	L2CAPConfirm_Status_gHciAlreadyInit_c = 0x01A0,
	L2CAPConfirm_Status_gHciInvalidParameter_c = 0x01A1,
	L2CAPConfirm_Status_gHciCallbackNotInstalled_c = 0x01A2,
	L2CAPConfirm_Status_gHciCallbackAlreadyInstalled_c = 0x01A3,
	L2CAPConfirm_Status_gHciCommandNotSupported_c = 0x01A4,
	L2CAPConfirm_Status_gHciEventNotSupported_c = 0x01A5,
	L2CAPConfirm_Status_gHciTransportError_c = 0x01A6,
	L2CAPConfirm_Status_gL2caAlreadyInit_c = 0x03F0,
	L2CAPConfirm_Status_gL2caInsufficientResources_c = 0x03F1,
	L2CAPConfirm_Status_gL2caCallbackNotInstalled_c = 0x03F2,
	L2CAPConfirm_Status_gL2caCallbackAlreadyInstalled_c = 0x03F3,
	L2CAPConfirm_Status_gL2caLePsmInvalid_c = 0x03F4,
	L2CAPConfirm_Status_gL2caLePsmAlreadyRegistered_c = 0x03F5,
	L2CAPConfirm_Status_gL2caLePsmNotRegistered_c = 0x03F6,
	L2CAPConfirm_Status_gL2caLePsmInsufficientResources_c = 0x03F7,
	L2CAPConfirm_Status_gL2caChannelInvalid_c = 0x03F8,
	L2CAPConfirm_Status_gL2caChannelClosed_c = 0x03F9,
	L2CAPConfirm_Status_gL2caChannelAlreadyConnected_c = 0x03FA,
	L2CAPConfirm_Status_gL2caConnectionParametersRejected_c = 0x03FB,
	L2CAPConfirm_Status_gL2caChannelBusy_c = 0x03FC,
	L2CAPConfirm_Status_gL2caInvalidParameter_c = 0x03FE,
	L2CAPConfirm_Status_gL2caError_c = 0x03FF,
	L2CAPConfirm_Status_gSmNullCBFunction_c = 0x0401,
	L2CAPConfirm_Status_gSmCommandNotSupported_c = 0x0402,
	L2CAPConfirm_Status_gSmUnexpectedCommand_c = 0x0403,
	L2CAPConfirm_Status_gSmInvalidCommandCode_c = 0x0404,
	L2CAPConfirm_Status_gSmInvalidCommandLength_c = 0x0405,
	L2CAPConfirm_Status_gSmInvalidCommandParameter_c = 0x0406,
	L2CAPConfirm_Status_gSmInvalidDeviceId_c = 0x0407,
	L2CAPConfirm_Status_gSmInvalidInternalOperation_c = 0x0408,
	L2CAPConfirm_Status_gSmInvalidConnectionHandle_c = 0x0409,
	L2CAPConfirm_Status_gSmInproperKeyDistributionField_c = 0x040A,
	L2CAPConfirm_Status_gSmUnexpectedKeyType_c = 0x040B,
	L2CAPConfirm_Status_gSmUnexpectedPairingTerminationReason_c = 0x040C,
	L2CAPConfirm_Status_gSmUnexpectedKeyset_c = 0x040D,
	L2CAPConfirm_Status_gSmSmpTimeoutOccurred_c = 0x040E,
	L2CAPConfirm_Status_gSmUnknownSmpPacketType_c = 0x040F,
	L2CAPConfirm_Status_gSmInvalidSmpPacketLength_c = 0x0410,
	L2CAPConfirm_Status_gSmInvalidSmpPacketParameter_c = 0x0411,
	L2CAPConfirm_Status_gSmReceivedUnexpectedSmpPacket_c = 0x0412,
	L2CAPConfirm_Status_gSmReceivedSmpPacketFromUnknownDevice_c = 0x0413,
	L2CAPConfirm_Status_gSmReceivedUnexpectedHciEvent_c = 0x0414,
	L2CAPConfirm_Status_gSmReceivedHciEventFromUnknownDevice_c = 0x0415,
	L2CAPConfirm_Status_gSmInvalidHciEventParameter_c = 0x0416,
	L2CAPConfirm_Status_gSmLlConnectionEncryptionInProgress_c = 0x0417,
	L2CAPConfirm_Status_gSmLlConnectionEncryptionFailure_c = 0x0418,
	L2CAPConfirm_Status_gSmInsufficientResources_c = 0x0419,
	L2CAPConfirm_Status_gSmOobDataAddressMismatch_c = 0x041A,
	L2CAPConfirm_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
	L2CAPConfirm_Status_gSmPairingErrorPasskeyEntryFailed_c = 0x0431,
	L2CAPConfirm_Status_gSmPairingErrorConfirmValueFailed_c = 0x0432,
	L2CAPConfirm_Status_gSmPairingErrorCommandNotSupported_c = 0x0433,
	L2CAPConfirm_Status_gSmPairingErrorInvalidParameters_c = 0x0434,
	L2CAPConfirm_Status_gSmPairingErrorUnknownReason_c = 0x0435,
	L2CAPConfirm_Status_gSmTbResolvableAddressDoesNotMatchIrk_c = 0x0460,
	L2CAPConfirm_Status_gSmTbInvalidDataSignature_c = 0x0461,
	L2CAPConfirm_Status_gAttInvalidHandle_c = 0x0501,
	L2CAPConfirm_Status_gAttReadNotPermitted_c = 0x0502,
	L2CAPConfirm_Status_gAttWriteNotPermitted_c = 0x0503,
	L2CAPConfirm_Status_gAttInvalidPdu_c = 0x0504,
	L2CAPConfirm_Status_gAttInsufficientAuthentication_c = 0x0505,
	L2CAPConfirm_Status_gAttRequestNotSupported_c = 0x0506,
	L2CAPConfirm_Status_gAttInvalidOffset_c = 0x0507,
	L2CAPConfirm_Status_gAttInsufficientAuthorization_c = 0x0508,
	L2CAPConfirm_Status_gAttPrepareQueueFull_c = 0x0509,
	L2CAPConfirm_Status_gAttAttributeNotFound_c = 0x050A,
	L2CAPConfirm_Status_gAttAttributeNotLong_c = 0x050B,
	L2CAPConfirm_Status_gAttInsufficientEncryptionKeySize_c = 0x050C,
	L2CAPConfirm_Status_gAttInvalidAttributeValueLength_c = 0x050D,
	L2CAPConfirm_Status_gAttUnlikelyor_c = 0x050E,
	L2CAPConfirm_Status_gAttInsufficientEncryption_c = 0x050F,
	L2CAPConfirm_Status_gAttUnsupportedGroupType_c = 0x0510,
	L2CAPConfirm_Status_gAttInsufficientResources_c = 0x0511,
	L2CAPConfirm_Status_gGattAnotherProcedureInProgress_c = 0x0601,
	L2CAPConfirm_Status_gGattLongAttributePacketsCorrupted_c = 0x0602,
	L2CAPConfirm_Status_gGattMultipleAttributesOverflow_c = 0x0603,
	L2CAPConfirm_Status_gGattUnexpectedReadMultipleResponseLength_c = 0x0604,
	L2CAPConfirm_Status_gGattInvalidValueLength_c = 0x0605,
	L2CAPConfirm_Status_gGattServerTimeout_c = 0x0606,
	L2CAPConfirm_Status_gGattIndicationAlreadyInProgress_c = 0x0607,
	L2CAPConfirm_Status_gGattClientConfirmationTimeout_c = 0x0608,
	L2CAPConfirm_Status_gGapAdvDataTooLong_c = 0x0701,
	L2CAPConfirm_Status_gGapScanRspDataTooLong_c = 0x0702,
	L2CAPConfirm_Status_gGapDeviceNotBonded_c = 0x0703,
	L2CAPConfirm_Status_gDevDbCccdLimitReached_c = 0x0801,
	L2CAPConfirm_Status_gDevDbCccdNotFound_c = 0x0802,
	L2CAPConfirm_Status_gGattDbInvalidHandle_c = 0x0901,
	L2CAPConfirm_Status_gGattDbCharacteristicNotFound_c = 0x0902,
	L2CAPConfirm_Status_gGattDbCccdNotFound_c = 0x0903,
	L2CAPConfirm_Status_gGattDbServiceNotFound_c = 0x0904,
	L2CAPConfirm_Status_gGattDbDescriptorNotFound_c = 0x0905
} L2CAPConfirm_Status_t;

typedef PACKED_STRUCT L2CAPConfirm_tag {
	L2CAPConfirm_Status_t Status;  // The status of the L2CAP request
} L2CAPConfirm_t;

typedef struct L2CAPLePsmConnectionRequestIndication_tag {
...
} L2CAPLePsmConnectionRequestIndication_t;

/* Connection result */
typedef enum L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_tag {
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gSuccessful_c = 0x0000,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gLePsmNotSupported_c = 0x0002,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gNoResourcesAvailable_c = 0x0004,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gInsufficientAuthentication_c = 0x0005,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gInsufficientAuthorization_c = 0x0006,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gInsufficientEncryptionKeySize_c = 0x0007,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gInsufficientEncryption_c = 0x0008,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gInvalidSourceCid_c = 0x0009,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gSourceCidAlreadyAllocated_c = 0x000A,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gCommandRejected_c = 0x0100,
	L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_gResponseTimeout_c = 0xFFFE
} L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_t;

typedef struct L2CAPLePsmConnectionCompleteIndication_tag {
	bool_t InformationIncluded;  // Information is included or not
	struct {
		uint8_t DeviceId;  // The DeviceId for which the command is intended
		uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
		...
		uint16_t InitialCredits;  // Initial credits
		L2CAPLePsmConnectionCompleteIndication_LeCbConnectionComplete_Result_t Result;  // Connection result
	} LeCbConnectionComplete;  // Connection complete event data
} L2CAPLePsmConnectionCompleteIndication_t;

typedef struct L2CAPLePsmDisconnectNotificationIndication_tag {
	bool_t InformationIncluded;  // Information is included or not
	struct {
		uint8_t DeviceId;  // The DeviceId for which the command is intended
		uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
	} LeCbDisconnection;  // Disconnection event data
} L2CAPLePsmDisconnectNotificationIndication_t;

typedef struct L2CAPNoPeerCreditsIndication_tag {
	bool_t InformationIncluded;  // Information is included or not
	struct {
		uint8_t DeviceId;  // The DeviceId for which the command is intended
		uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
	} LeCbNoPeerCredits;  // No peer credits event data
} L2CAPNoPeerCreditsIndication_t;

typedef struct L2CAPLocalCreditsNotificationIndication_tag {
	bool_t InformationIncluded;  // Information is included or not
	struct {
		uint8_t DeviceId;  // The DeviceId for which the command is intended
		uint16_t ChannelId;  // The L2CAP Channel Id assigned on the initiator
...
} L2CAPLocalCreditsNotificationIndication_t;

typedef struct L2CAPLeCbDataIndication_tag {
...
typedef enum GATTConfirm_Status_tag {
	...
	GATTConfirm_Status_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTConfirm_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureExchangeMtuIndication_Error_tag {
	...
	GATTClientProcedureExchangeMtuIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureExchangeMtuIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureDiscoverAllPrimaryServicesIndication_Error_tag {
	...
	GATTClientProcedureDiscoverAllPrimaryServicesIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureDiscoverAllPrimaryServicesIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureDiscoverPrimaryServicesByUuidIndication_Error_tag {
	...
	GATTClientProcedureDiscoverPrimaryServicesByUuidIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureDiscoverPrimaryServicesByUuidIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureFindIncludedServicesIndication_Error_tag {
	...
	GATTClientProcedureFindIncludedServicesIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureFindIncludedServicesIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureDiscoverAllCharacteristicsIndication_Error_tag {
	...
	GATTClientProcedureDiscoverAllCharacteristicsIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureDiscoverAllCharacteristicsIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureDiscoverCharacteristicByUuidIndication_Error_tag {
	...
	GATTClientProcedureDiscoverCharacteristicByUuidIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureDiscoverCharacteristicByUuidIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureDiscoverAllCharacteristicDescriptorsIndication_Error_tag {
	...
	GATTClientProcedureDiscoverAllCharacteristicDescriptorsIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureDiscoverAllCharacteristicDescriptorsIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureReadCharacteristicValueIndication_Error_tag {
	...
	GATTClientProcedureReadCharacteristicValueIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureReadCharacteristicValueIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureReadUsingCharacteristicUuidIndication_Error_tag {
	...
	GATTClientProcedureReadUsingCharacteristicUuidIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureReadUsingCharacteristicUuidIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureReadMultipleCharacteristicValuesIndication_Error_tag {
	...
	GATTClientProcedureReadMultipleCharacteristicValuesIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureReadMultipleCharacteristicValuesIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureWriteCharacteristicValueIndication_Error_tag {
	...
	GATTClientProcedureWriteCharacteristicValueIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureWriteCharacteristicValueIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureReadCharacteristicDescriptorIndication_Error_tag {
	...
	GATTClientProcedureReadCharacteristicDescriptorIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureReadCharacteristicDescriptorIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GATTClientProcedureWriteCharacteristicDescriptorIndication_Error_tag {
	...
	GATTClientProcedureWriteCharacteristicDescriptorIndication_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTClientProcedureWriteCharacteristicDescriptorIndication_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef PACKED_STRUCT GATTServerMtuChangedIndication_tag {
	uint8_t DeviceId;  // Device ID identifying the active connection
	uint16_t MtuChangedEvent_NewMtu;  // Mtu changed event
...
typedef enum GATTServerErrorIndication_ProcedureError_Error_tag {
	...
	GATTServerErrorIndication_ProcedureError_Error_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTServerErrorIndication_ProcedureError_Error_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef PACKED_STRUCT GATTServerAttributeReadIndication_tag {
	uint8_t DeviceId;  // Device ID identifying the active connection
	uint16_t AttributeReadEvent_Handle;  // Attribute read event
...
typedef enum GATTDBConfirm_Status_tag {
	...
	GATTDBConfirm_Status_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GATTDBConfirm_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPConfirm_Status_tag {
	...
	GAPConfirm_Status_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPConfirm_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef struct GAPGetBondedStaticAddressesIndication_tag {
	uint8_t NbOfDeviceAddresses;  // The number of device addresses
	uint8_t *DeviceAddresses;  // Device addresses list
} GAPGetBondedStaticAddressesIndication_t;
...
typedef enum GAPGenericEventInternalErrorIndication_ErrorCode_tag {
	...
	GAPGenericEventInternalErrorIndication_ErrorCode_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPGenericEventInternalErrorIndication_ErrorCode_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPGenericEventInternalErrorIndication_ErrorSource_tag {
	...
	GAPGenericEventInternalErrorIndication_ErrorSource_gEnableControllerPrivacy_c = 0x1F,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeScSendKeypressNotification_c = 0x20,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeScSetPeerOobData_c = 0x21,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeScGetLocalOobData_c = 0x22,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeScValidateNumericValue_c = 0x23,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeScRegeneratePublicKey_c = 0x24,
	GAPGenericEventInternalErrorIndication_ErrorSource_gLeSetResolvablePrivateAddressTimeout_c = 0x25
...
typedef enum GAPGenericEventAdvertisingSetupFailedIndication_SetupFailReason_tag {
	...
	GAPGenericEventAdvertisingSetupFailedIndication_SetupFailReason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPGenericEventAdvertisingSetupFailedIndication_SetupFailReason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPAdvertisingEventCommandFailedIndication_FailReason_tag {
	...
	GAPAdvertisingEventCommandFailedIndication_FailReason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPAdvertisingEventCommandFailedIndication_FailReason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPScanningEventCommandFailedIndication_FailReason_tag {
	...
	GAPScanningEventCommandFailedIndication_FailReason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPScanningEventCommandFailedIndication_FailReason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPConnectionEventPairingCompleteIndication_PairingData_PairingFailed_FailReason_tag {
	...
	GAPConnectionEventPairingCompleteIndication_PairingData_PairingFailed_FailReason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPConnectionEventPairingCompleteIndication_PairingData_PairingFailed_FailReason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef struct GAPConnectionEventPairingCompleteIndication_tag {
	...
	union {
		bool_t PairingSuccessful_WithBonding;  // Pairing successful data

		GAPConnectionEventPairingCompleteIndication_PairingData_PairingFailed_FailReason_t PairingFailed_FailReason;  // Pairing failed data
...
typedef enum GAPConnectionEventDisconnectedIndication_Reason_tag {
	...
	GAPConnectionEventDisconnectedIndication_Reason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPConnectionEventDisconnectedIndication_Reason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPConnectionEventPowerReadFailureIndication_FailReason_tag {
	...
	GAPConnectionEventPowerReadFailureIndication_FailReason_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPConnectionEventPowerReadFailureIndication_FailReason_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef enum GAPConnectionEventParameterUpdateCompleteIndication_ConnectionParameterUpdateComplete_Status_tag {
	...
	GAPConnectionEventParameterUpdateCompleteIndication_ConnectionParameterUpdateComplete_Status_gHciConnectionFailedToBeEstablished_c = 0x013E,
	...
	GAPConnectionEventParameterUpdateCompleteIndication_ConnectionParameterUpdateComplete_Status_gSmSmpPacketReceivedAfterTimeoutOccurred_c = 0x041A,
...
typedef PACKED_STRUCT GAPConnectionEventLeScKeypressNotificationIndication_tag {
	uint8_t DeviceId;  // Device ID identifying the connection
	GAPConnectionEventLeScKeypressNotificationIndication_GapLeScKeypressNotificationParams_keypressNotifType_t GapLeScKeypressNotificationParams_keypressNotifType;  // Keypress notification type which denotes a passkey entry keypress action
...
typedef struct bleEvtContainer_tag
{
	...
	union {
		...
		L2CAPConfirm_t L2CAPConfirm;
		L2CAPLePsmConnectionRequestIndication_t L2CAPLePsmConnectionRequestIndication;
		L2CAPLePsmConnectionCompleteIndication_t L2CAPLePsmConnectionCompleteIndication;
		L2CAPLePsmDisconnectNotificationIndication_t L2CAPLePsmDisconnectNotificationIndication;
		L2CAPNoPeerCreditsIndication_t L2CAPNoPeerCreditsIndication;
		L2CAPLocalCreditsNotificationIndication_t L2CAPLocalCreditsNotificationIndication;
		L2CAPLeCbDataIndication_t L2CAPLeCbDataIndication;
		...
		GAPGetBondedStaticAddressesIndication_t GAPGetBondedStaticAddressesIndication;
...
==================================================================================================*/
memStatus_t L2CAPRegisterLePsmRequest(L2CAPRegisterLePsmRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPDeregisterLePsmRequest(L2CAPDeregisterLePsmRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPConnectLePsmRequest(L2CAPConnectLePsmRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPDisconnectLeCbChannelRequest(L2CAPDisconnectLeCbChannelRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPCancelConnectionRequest(L2CAPCancelConnectionRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPSendLeCbDataRequest(L2CAPSendLeCbDataRequest_t *req, uint32_t fsciInterface);
memStatus_t L2CAPSendLeCreditRequest(L2CAPSendLeCreditRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTInitRequest(uint32_t fsciInterface);
memStatus_t GATTGetMtuRequest(GATTGetMtuRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientInitRequest(uint32_t fsciInterface);
memStatus_t GATTClientResetProcedureRequest(uint32_t fsciInterface);
memStatus_t GATTClientRegisterProcedureCallbackRequest(uint32_t fsciInterface);
memStatus_t GATTClientRegisterNotificationCallbackRequest(uint32_t fsciInterface);
memStatus_t GATTClientRegisterIndicationCallbackRequest(uint32_t fsciInterface);
memStatus_t GATTClientExchangeMtuRequest(GATTClientExchangeMtuRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientDiscoverAllPrimaryServicesRequest(GATTClientDiscoverAllPrimaryServicesRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientDiscoverPrimaryServicesByUuidRequest(GATTClientDiscoverPrimaryServicesByUuidRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientFindIncludedServicesRequest(GATTClientFindIncludedServicesRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientDiscoverAllCharacteristicsOfServiceRequest(GATTClientDiscoverAllCharacteristicsOfServiceRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientDiscoverCharacteristicOfServiceByUuidRequest(GATTClientDiscoverCharacteristicOfServiceByUuidRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientDiscoverAllCharacteristicDescriptorsRequest(GATTClientDiscoverAllCharacteristicDescriptorsRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientReadCharacteristicValueRequest(GATTClientReadCharacteristicValueRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientReadUsingCharacteristicUuidRequest(GATTClientReadUsingCharacteristicUuidRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientReadMultipleCharacteristicValuesRequest(GATTClientReadMultipleCharacteristicValuesRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientWriteCharacteristicValueRequest(GATTClientWriteCharacteristicValueRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientReadCharacteristicDescriptorRequest(GATTClientReadCharacteristicDescriptorRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTClientWriteCharacteristicDescriptorRequest(GATTClientWriteCharacteristicDescriptorRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerInitRequest(uint32_t fsciInterface);
memStatus_t GATTServerRegisterCallbackRequest(uint32_t fsciInterface);
memStatus_t GATTServerRegisterHandlesForWriteNotificationsRequest(GATTServerRegisterHandlesForWriteNotificationsRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendAttributeWrittenStatusRequest(GATTServerSendAttributeWrittenStatusRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendNotificationRequest(GATTServerSendNotificationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendIndicationRequest(GATTServerSendIndicationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendInstantValueNotificationRequest(GATTServerSendInstantValueNotificationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendInstantValueIndicationRequest(GATTServerSendInstantValueIndicationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerRegisterHandlesForReadNotificationsRequest(GATTServerRegisterHandlesForReadNotificationsRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTServerSendAttributeReadStatusRequest(GATTServerSendAttributeReadStatusRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBInitRequest(uint32_t fsciInterface);
memStatus_t GATTDBWriteAttributeRequest(GATTDBWriteAttributeRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBReadAttributeRequest(GATTDBReadAttributeRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBFindServiceHandleRequest(GATTDBFindServiceHandleRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBFindCharValueHandleInServiceRequest(GATTDBFindCharValueHandleInServiceRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBFindCccdHandleForCharValueHandleRequest(GATTDBFindCccdHandleForCharValueHandleRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBFindDescriptorHandleForCharValueHandleRequest(GATTDBFindDescriptorHandleForCharValueHandleRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicInitRequest(uint32_t fsciInterface);
memStatus_t GATTDBDynamicReleaseDatabaseRequest(uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddPrimaryServiceDeclarationRequest(GATTDBDynamicAddPrimaryServiceDeclarationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddSecondaryServiceDeclarationRequest(GATTDBDynamicAddSecondaryServiceDeclarationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddIncludeDeclarationRequest(GATTDBDynamicAddIncludeDeclarationRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddCharacteristicDeclarationAndValueRequest(GATTDBDynamicAddCharacteristicDeclarationAndValueRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddCharacteristicDescriptorRequest(GATTDBDynamicAddCharacteristicDescriptorRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddCccdRequest(uint32_t fsciInterface);
memStatus_t GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueRequest(GATTDBDynamicAddCharacteristicDeclarationWithUniqueValueRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicRemoveServiceRequest(GATTDBDynamicRemoveServiceRequest_t *req, uint32_t fsciInterface);
memStatus_t GATTDBDynamicRemoveCharacteristicRequest(GATTDBDynamicRemoveCharacteristicRequest_t *req, uint32_t fsciInterface);
memStatus_t BLEHostInitializeRequest(uint32_t fsciInterface);
memStatus_t GAPRegisterDeviceSecurityRequirementsRequest(GAPRegisterDeviceSecurityRequirementsRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetAdvertisingParametersRequest(GAPSetAdvertisingParametersRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetAdvertisingDataRequest(GAPSetAdvertisingDataRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPStartAdvertisingRequest(uint32_t fsciInterface);
memStatus_t GAPStopAdvertisingRequest(uint32_t fsciInterface);
memStatus_t GAPAuthorizeRequest(GAPAuthorizeRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSaveCccdRequest(GAPSaveCccdRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPCheckNotificationStatusRequest(GAPCheckNotificationStatusRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPCheckIndicationStatusRequest(GAPCheckIndicationStatusRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPGetBondedStaticAddressesRequest(GAPGetBondedStaticAddressesRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPPairRequest(GAPPairRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSendSlaveSecurityRequestRequest(GAPSendSlaveSecurityRequestRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPEncryptLinkRequest(GAPEncryptLinkRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPAcceptPairingRequestRequest(GAPAcceptPairingRequestRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRejectPairingRequest(GAPRejectPairingRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPEnterPasskeyRequest(GAPEnterPasskeyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPProvideOobRequest(GAPProvideOobRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRejectPasskeyRequestRequest(GAPRejectPasskeyRequestRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSendSmpKeysRequest(GAPSendSmpKeysRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRejectKeyExchangeRequestRequest(GAPRejectKeyExchangeRequestRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPProvideLongTermKeyRequest(GAPProvideLongTermKeyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPDenyLongTermKeyRequest(GAPDenyLongTermKeyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPLoadEncryptionInformationRequest(GAPLoadEncryptionInformationRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetLocalPasskeyRequest(GAPSetLocalPasskeyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPStartScanningRequest(GAPStartScanningRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPStopScanningRequest(uint32_t fsciInterface);
memStatus_t GAPConnectRequest(GAPConnectRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPDisconnectRequest(GAPDisconnectRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSaveCustomPeerInformationRequest(GAPSaveCustomPeerInformationRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPLoadCustomPeerInformationRequest(GAPLoadCustomPeerInformationRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPCheckIfBondedRequest(GAPCheckIfBondedRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPReadWhiteListSizeRequest(uint32_t fsciInterface);
memStatus_t GAPClearWhiteListRequest(uint32_t fsciInterface);
memStatus_t GAPAddDeviceToWhiteListRequest(GAPAddDeviceToWhiteListRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRemoveDeviceFromWhiteListRequest(GAPRemoveDeviceFromWhiteListRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPReadPublicDeviceAddressRequest(uint32_t fsciInterface);
memStatus_t GAPCreateRandomDeviceAddressRequest(GAPCreateRandomDeviceAddressRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSaveDeviceNameRequest(GAPSaveDeviceNameRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPGetBondedDevicesCountRequest(uint32_t fsciInterface);
memStatus_t GAPGetBondedDeviceNameRequest(GAPGetBondedDeviceNameRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRemoveBondRequest(GAPRemoveBondRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPRemoveAllBondsRequest(uint32_t fsciInterface);
memStatus_t GAPReadRadioPowerLevelRequest(GAPReadRadioPowerLevelRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPVerifyPrivateResolvableAddressRequest(GAPVerifyPrivateResolvableAddressRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetRandomAddressRequest(GAPSetRandomAddressRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetScanModeRequest(GAPSetScanModeRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPSetDefaultPairingParametersRequest(GAPSetDefaultPairingParametersRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPUpdateConnectionParametersRequest(GAPUpdateConnectionParametersRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPEnableUpdateConnectionParametersRequest(GAPEnableUpdateConnectionParametersRequest_t *req, uint32_t fsciInterface);
memStatus_t GapUpdateLeDataLengthRequest(GapUpdateLeDataLengthRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPControllerResetRequest(uint32_t fsciInterface);
memStatus_t GAPEnableHostPrivacyRequest(GAPEnableHostPrivacyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPEnableControllerPrivacyRequest(GAPEnableControllerPrivacyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPLeScRegeneratePublicKeyRequest(uint32_t fsciInterface);
memStatus_t GAPLeScValidateNumericValueRequest(GAPLeScValidateNumericValueRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPLeScGetLocalOobDataRequest(uint32_t fsciInterface);
memStatus_t GAPLeScSetPeerOobDataRequest(GAPLeScSetPeerOobDataRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPLeScSendKeypressNotificationPrivacyRequest(GAPLeScSendKeypressNotificationPrivacyRequest_t *req, uint32_t fsciInterface);
memStatus_t GAPGetBondedDevicesIdentityInformationRequest(GAPGetBondedDevicesIdentityInformationRequest_t *req, uint32_t fsciInterface);
memStatus_t FSCIAllowDeviceToSleepRequest(FSCIAllowDeviceToSleepRequest_t *req, uint32_t fsciInterface);
memStatus_t FSCIGetWakeupReasonRequest(uint32_t fsciInterface);
