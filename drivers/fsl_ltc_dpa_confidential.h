...
/*!
 * @brief Init the LTC DPA handle which is used in transcational functions
 *
...
/*!
 * @brief Set number of dummy operations added per one real operation.
 * LTC_CreateHandleDPA() uses this function to configure default Nd = 15.
 *
 * This function sets runtime parameter of number of dummy operation added
 * per one real operation. Possible values have an upper limit FSL_LTC_DPA_MAX_ND.
 * The parameter is stored in the handle and read by the driver from the handle when it executes
 * encryption or decryption. This function can be called any time.
 *
 * @param[in,out] handle    Pointer to ltc_dpa_handle_t structure
 * @param probability  Probability that a dummy operation runs to completion.
 */
...
/*!
 * @brief Set probability a dummy operation runs to completion.
 * LTC_CreateHandleDPA() uses this function to configure default probability = 100%,
 * means in default setting all dummy operations run to completion.
 *
 * This function sets runtime parameter of probability a dummy operation runs to completion.
 * The parameter is stored in the handle and read by the driver from the handle when it executes
 * encryption or decryption. This function can be called any time.
 *
 * @param[in,out] handle    Pointer to ltc_dpa_handle_t structure
 * @param probability  Probability that a dummy operation runs to completion. Possible values are integer values 0 to
 * 100.
 */
...
/*!
 * @addtogroup ltc_driver_aes_with_dpa
 * @{
 */
...
/*!
 * @addtogroup ltc_driver_des_with_dpa
 * @{
 */
...
/*!
 * @addtogroup ltc_driver_cmac_with_dpa
 * @{
 */
/*!
