...
#define HID_USAGE_HIDTC_DATA_OUT(__id, __count, __size)       \
      0x85, ((uint_8)(__id)),       /*   REPORT_ID (__id) */      \
      0x19, 0x01,                    /*   USAGE_MINIMUM (1)*/      \
      0x29, 0x01,                    /*   USAGE_MAXIMUM (1)*/      \
      0x15, 0x00,                    /*   LOGICAL_MINIMUM (0)*/    \
      0x26, 0xff, 0x00,              /*   LOGICAL_MAXIMUM (255)*/  \
      0x75, ((uint_8)(__size)),     /*   REPORT_SIZE (n)*/        \
      0x95, ((uint_8)(__count)),    /*   REPORT_COUNT (n)*/       \
...
uint_8 USB_DESC_CONST g_device_descriptor[DEVICE_DESCRIPTOR_SIZE] =
{
   ...
   0x73,0x00,                            /*  Product ID for KL25Z48M       */
      ...
      case USB_STRING_DESCRIPTOR:
        ...
        
        {
            if(index == 0)
            {
                ...
                *descriptor = (uint_8_ptr)g_lang_ptr->languages_supported_string;
                *size = g_lang_ptr->languages_supported_size;
            } else
            {
                uint_8 lang_id=0;
                ...
                for(;lang_id< USB_MAX_LANGUAGES_SUPPORTED;lang_id++)
                {
                    ...
                    if(index == g_lang_ptr->usb_language[lang_id].language_id)
                ...
                *descriptor = (uint_8_ptr)g_lang_ptr->usb_language[lang_id].
                                                    lang_desc[lang_index];
                *size = g_lang_ptr->usb_language[lang_id].
