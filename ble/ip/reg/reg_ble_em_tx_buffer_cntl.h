...
__FORCEINLINE uint16_t ble_txbufcntl_getf(int elt_idx, int reg_idx)
{
    ASSERT_ERR(reg_idx <= 18);
...
__FORCEINLINE void ble_txbufcntl_setf(int elt_idx, int reg_idx, uint16_t txbufcntl)
{
    ASSERT_ERR(reg_idx <= 18);
