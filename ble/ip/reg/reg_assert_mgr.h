...
__FORCEINLINE void asrt_assert_pack(uint8_t txtsize, uint8_t params, uint8_t warn, uint8_t trigg)
{
...
__FORCEINLINE void asrt_assert_unpack(uint8_t* txtsize, uint8_t* params, uint8_t* warn, uint8_t* trigg)
{
...
__FORCEINLINE void asrt_param_pack(uint16_t param2, uint16_t param1)
{
...
__FORCEINLINE void asrt_param_unpack(uint16_t* param2, uint16_t* param1)
{
...
__FORCEINLINE uint16_t asrt_param_2_getf(void)
{
    uint32_t localVal = REG_PL_RD(ASRT_PARAM_ADDR);
    return ((localVal & ((uint32_t)0xFFFF0000)) >> 16);
}

__FORCEINLINE void asrt_param_2_setf(uint16_t param2)
{
    ASSERT_ERR((((uint32_t)param2 << 16) & ~((uint32_t)0xFFFF0000)) == 0);
    REG_PL_WR(ASRT_PARAM_ADDR, (REG_PL_RD(ASRT_PARAM_ADDR) & ~((uint32_t)0xFFFF0000)) | ((uint32_t)param2 << 16));
}

__FORCEINLINE uint16_t asrt_param_1_getf(void)
{
    uint32_t localVal = REG_PL_RD(ASRT_PARAM_ADDR);
    return ((localVal & ((uint32_t)0x0000FFFF)) >> 0);
}

__FORCEINLINE void asrt_param_1_setf(uint16_t param1)
{
    ASSERT_ERR((((uint32_t)param1 << 0) & ~((uint32_t)0x0000FFFF)) == 0);
...
__FORCEINLINE uint32_t asrt_line_getf(void)
{
...
__FORCEINLINE void asrt_line_setf(uint32_t line)
{
...
__FORCEINLINE uint32_t asrt_addr_getf(void)
{
...
__FORCEINLINE void asrt_addr_setf(uint32_t addr)
{
 ...
 * </pre>
 */
#define ASRT_VSP_ADDR     0x4008D0FC 
#define ASRT_VSP_OFFSET   0x00000010
#define ASRT_VSP_INDEX    0x00000001
#define ASRT_VSP_RESET    0x00000000

__FORCEINLINE uint32_t asrt_vsp_get(void)
{
    return REG_PL_RD(ASRT_VSP_ADDR);
}

__FORCEINLINE void asrt_vsp_set(uint32_t value)
{
    REG_PL_WR(ASRT_VSP_ADDR, value);
}
