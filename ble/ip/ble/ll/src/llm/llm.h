...
#define LLM_LE_ADV_DUMMY_IDX (BLE_TX_DESC_CNTL - 1)
#define LLM_LE_SCAN_CON_REQ_ADV_DIR_IDX (BLE_TX_DESC_CNTL + 0)
#define LLM_LE_SCAN_RSP_IDX (BLE_TX_DESC_CNTL + 1)
#define LLM_LE_ADV_IDX (BLE_TX_DESC_CNTL + 2)
...
#if !(BLE_QUALIF)
/// Features byte 0
#define BLE_FEATURES_BYTE0                                                                                       \
    (BLE_ENC_FEATURE | BLE_CON_PARAM_REQ_PROC_FEATURE | BLE_REJ_IND_EXT_FEATURE | BLE_SLAVE_INIT_EXCHG_FEATURE | \
     BLE_PING_FEATURE | BLE_LENGTH_EXT_FEATURE | BLE_LL_PRIVACY_FEATURE | BLE_EXT_SCAN_POLICY_FEATURE)
/// Features byte 1
#if (BLE_2MBPS)
...
/// States byte 0
#define BLE_STATES_BYTE0                                                                                               \
    (BLE_NON_CON_ADV_STATE | BLE_DISC_ADV_STATE | BLE_CON_ADV_STATE | BLE_HDC_DIRECT_ADV_STATE | BLE_PASS_SCAN_STATE | \
     BLE_ACTIV_SCAN_STATE | BLE_INIT_MASTER_STATE | BLE_CON_SLAVE_STATE)
#if !(BLE_QUALIF)
/// States byte 1
#define BLE_STATES_BYTE1                                                                                     \
    (BLE_NON_CON_ADV_PASS_SCAN_STATE | BLE_DISC_ADV_PASS_SCAN_STATE | BLE_CON_ADV_PASS_SCAN_STATE |          \
     BLE_HDC_DIRECT_ADV_PASS_SCAN_STATE | BLE_NON_CON_ADV_ACTIV_SCAN_STATE | BLE_DISC_ADV_ACTIV_SCAN_STATE | \
     BLE_CON_ADV_ACTIV_SCAN_STATE | BLE_HDC_DIRECT_ADV_ACTIV_SCAN_STATE)

/// States byte 2
#define BLE_STATES_BYTE2                                                                                               \
    (BLE_NON_CON_ADV_INIT_STATE | BLE_DISC_ADV_INIT_STATE | BLE_NON_CON_ADV_MASTER_STATE | BLE_DISC_ADV_MASTER_STATE | \
     BLE_NON_CON_ADV_SLAVE_STATE | BLE_DISC_ADV_SLAVE_STATE | BLE_PASS_SCAN_INIT_STATE | BLE_ACTIV_SCAN_INIT_STATE)

/// States byte 3
#define BLE_STATES_BYTE3                                                                    \
    (BLE_PASS_SCAN_MASTER_STATE | BLE_ACTIV_SCAN_MASTER_STATE | BLE_PASS_SCAN_SLAVE_STATE | \
     BLE_ACTIV_SCAN_SLAVE_STATE | BLE_INIT_MASTER_MASTER_STATE | BLE_LDC_DIRECT_ADV_STATE | \
     BLE_LDC_DIRECT_ADV_PASS_SCAN_STATE | BLE_LDC_DIRECT_ADV_ACTIV_SCAN_STATE)

/// States byte 4
#define BLE_STATES_BYTE4                                                                                             \
    (BLE_CON_ADV_INIT_MASTER_SLAVE_STATE | BLE_HDC_DIRECT_ADV_INIT_MASTER_SLAVE_STATE |                              \
     BLE_LDC_DIRECT_ADV_INIT_MASTER_SLAVE_STATE | BLE_CON_ADV_MASTER_SLAVE_STATE |                                   \
     BLE_HDC_DIRECT_ADV_MASTER_SLAVE_STATE | BLE_LDC_DIRECT_ADV_MASTER_SLAVE_STATE | BLE_CON_ADV_SLAVE_SLAVE_STATE | \
...
/// States byte 2
#define BLE_STATES_BYTE2 \
    (BLE_NON_CON_ADV_MASTER_STATE | BLE_DISC_ADV_MASTER_STATE | BLE_NON_CON_ADV_SLAVE_STATE | BLE_DISC_ADV_SLAVE_STATE)

/// States byte 3
#define BLE_STATES_BYTE3                                                                    \
    (BLE_PASS_SCAN_MASTER_STATE | BLE_ACTIV_SCAN_MASTER_STATE | BLE_PASS_SCAN_SLAVE_STATE | \
     BLE_ACTIV_SCAN_SLAVE_STATE | BLE_INIT_MASTER_MASTER_STATE)
...
/// Pointer on the data scn response
extern struct ke_msg *llm_le_env_scn_data_rsp;
 ...
 ****************************************************************************************
 */
uint8_t llm_test_mode_start_tx(void const *param, ke_msg_id_t const msgid);
 ...
 ****************************************************************************************
 */
uint8_t llm_test_mode_start_rx(void const *param, ke_msg_id_t const msgid);
