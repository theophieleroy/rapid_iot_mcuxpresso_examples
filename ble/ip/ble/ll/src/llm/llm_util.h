 ...
 ****************************************************************************************
 */
__FORCEINLINE int8_t llm_util_ch_assess_get_upper_limit(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE int8_t llm_util_ch_assess_get_lower_limit(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE int8_t llm_util_ch_assess_get_reass_cnt(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE int8_t llm_util_ch_assess_get_rssi_noise(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE int8_t llm_util_ch_assess_get_assess_timer(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool llm_util_check_adv_report_list(struct bd_addr *adv_bd_addr, uint8_t adv_type)
{
    ...
    if (!found)
    {
        ...
        else
        {
            ...
            adv_device = (struct adv_device_list *)ke_malloc(sizeof(struct adv_device_list), KE_MEM_ENV);
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llm_util_set_param_scan_dft(void)
{
    // Allocate a structure containing scan parameters
    llm_le_env.scanning_params =
        (struct scanning_pdu_params *)ke_malloc(sizeof(struct scanning_pdu_params), KE_MEM_ENV);
...
*****************************************************************************************
*/
__FORCEINLINE void llm_util_aa_gen(uint8_t *acc_addr)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llm_util_gen_pattern(uint8_t pattern_type, uint8_t payload_len, uint8_t *payload)
{
    uint8_t pattern = 0;
    // get the pattern
    switch (pattern_type)
...
__FORCEINLINE void llm_util_set_param_adv_dft(void)
{
    // Allocate a structure containing scan parameters
    llm_le_env.advertising_params =
        (struct advertising_pdu_params *)ke_malloc(sizeof(struct advertising_pdu_params), KE_MEM_ENV);
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llm_util_chk_tst_mode(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint8_t llm_util_get_adv_type(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t llm_util_dle_get_tx_max_size(void)
{
...
/**
 ****************************************************************************************
 * @brief Check if scan response data need to be updated and update it if yes
 *
 ****************************************************************************************
 */
void llm_util_scn_data_update(void);
 ...
 ****************************************************************************************
 */
uint8_t llm_util_bl_check(
    const struct bd_addr *bd_addr_to_add, uint8_t bd_addr_type, uint16_t *conhdl, uint8_t wl_flag_action, bool *in_wl);
/**
 ****************************************************************************************
