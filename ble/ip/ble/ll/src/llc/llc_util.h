 ...
 ****************************************************************************************
 */
__FORCEINLINE uint8_t llc_util_get_active_conhdl(void)
{
    uint8_t idx;
    uint8_t cpt_active=0;
    ke_task_id_t llc_free;
    for(idx = 0; idx < FW_BLE_CONNECTION_MAX; idx++)
    {
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool llc_util_event_enabled(uint8_t meta_event)
{
    uint8_t idx;
    uint8_t cpt_active=0;
    ke_task_id_t llc_free;
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t llc_util_rxl2clen_getf(uint8_t *data)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llc_util_ivm_set(uint16_t conhdl, uint8_t const *ivm)
{
    for (int i = 0; i < 2; i++)
    {
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llc_util_ivs_set(uint16_t conhdl, uint8_t const *ivs)
{
    for (int i = 0; i < 2; i++)
    {
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool llc_util_disc_reason_ok(uint8_t reason)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llc_util_set_operation_ptr(uint16_t conhdl, uint8_t op_type, void* op)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void* llc_util_get_operation_ptr(uint16_t conhdl, uint8_t op_type)
{
    ASSERT_ERR(op_type < LLC_OP_MAX);
    struct llc_env_tag *llc_env_ptr = llc_env[conhdl];
 ...
 ****************************************************************************************
 */
__FORCEINLINE struct ea_elt_tag * llc_util_get_element_ptr(uint16_t conhdl)
{
    ASSERT_ERR(conhdl <= FW_BLE_CONNECTION_MAX);
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool llc_state_chk(ke_state_t state, uint8_t procedure)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void llc_state_update(ke_task_id_t task, ke_state_t *state, uint8_t procedure, bool enable)
{
    *state = enable ? ((*state) | (procedure)) : ((*state) & ~(procedure));

    ke_state_set(task, *state);
}
