...
#define LLD_EVT_ENV_ADDR_GET(elt) ((struct lld_evt_tag *)(&(elt->env)))
...
#define LLD_EVT_TAB_SIZE (FW_BLE_CONNECTION_MAX * 2 + 1)
...
#define LLD_EVT_ABORT_CNT_DURATION_US 480 //(440)

/// Prefetch time (in us)
#define LLD_EVT_PREFETCH_TIME_US 240 //(210)
...
#define LLD_EVT_FLAG_SET(evt, flag) (evt->evt_flag |= (LLD_EVT_FLAG_##flag))
/// Reset Event status flag
#define LLD_EVT_FLAG_RESET(evt, flag) (evt->evt_flag &= (~(LLD_EVT_FLAG_##flag)))
/// Get Event status flag
#define LLD_EVT_FLAG_GET(evt, flag) (evt->evt_flag & (LLD_EVT_FLAG_##flag))
...
extern uint8_t lld_evt_env_hw_wa_sleep_compensation;
/// use to know id a SW aes request has been postponed
extern volatile bool lld_evt_env_aes_sw_req;
/// Bit field used to know if an activity is encrypted
extern volatile uint32_t lld_evt_env_enc_evt_active;
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint8_t lld_evt_sca_get(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t lld_evt_time_get(void)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool lld_evt_time_cmp(uint32_t time1, uint32_t time2)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE bool lld_evt_time_past(uint32_t time)
{
 ...
 ****************************************************************************************
 */
void lld_evt_slave_update(struct llcp_con_upd_ind const *param_pdu, struct ea_elt_tag *elt_old);
 ...
 ****************************************************************************************
 */
struct ea_elt_tag *lld_evt_move_to_master(struct ea_elt_tag *elt_scan,
                                          uint16_t conhdl,
