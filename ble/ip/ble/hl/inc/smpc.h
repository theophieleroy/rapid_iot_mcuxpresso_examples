...
#define CFG_SMPC_REP_ATTEMPTS_TIMER_DEF_VAL     (200)      //2s
#define SMPC_REP_ATTEMPTS_TIMER_DEF_VAL         (ble_config.fw->smpc_rep_att_timer_def_val)
/// Repeated Attempts Timer max value (x10ms)
#define CFG_SMPC_REP_ATTEMPTS_TIMER_MAX_VAL     (3000)     //30s
#define SMPC_REP_ATTEMPTS_TIMER_MAX_VAL         (ble_config.fw->smpc_rep_att_timer_max_val)
/// Repeated Attempts Timer multiplier
#define CFG_SMPC_REP_ATTEMPTS_TIMER_MULT        (2)
#define SMPC_REP_ATTEMPTS_TIMER_MULT            (ble_config.fw->smpc_rep_att_timer_mult)

/**
 * Timeout Timer Configuration
 */
#define CFG_SMPC_TIMEOUT_TIMER_DURATION         (3000)     //30s
#define SMPC_TIMEOUT_TIMER_DURATION             (ble_config.fw->smpc_timout_timer_duration)
