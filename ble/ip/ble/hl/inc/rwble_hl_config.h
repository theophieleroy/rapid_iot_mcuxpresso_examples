...
#define APP_MAIN_TASK (ble_config.app->app_main_task)
...
#define BLE_TAG_GAPC_HEAP_ENV_SIZE (sizeof(struct gapc_env_tag *) * BLE_CONNECTION_MAX + KE_HEAP_MEM_RESERVED)
#else //(BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_GAPC 0
#define BLE_GAPC_HEAP_ENV_SIZE 0
#define BLE_TAG_GAPC_HEAP_ENV_SIZE 0
...
#define BLE_TAG_GATTC_HEAP_ENV_SIZE (sizeof(struct gattc_env_tag *) * BLE_CONNECTION_MAX + KE_HEAP_MEM_RESERVED)
#define BLE_L2CC_HEAP_ENV_SIZE (sizeof(struct l2cc_env_tag) + KE_HEAP_MEM_RESERVED)
#define BLE_TAG_L2CC_HEAP_ENV_SIZE (sizeof(struct l2cc_env_tag *) * BLE_CONNECTION_MAX + KE_HEAP_MEM_RESERVED)
#else //(BLE_CENTRAL || BLE_PERIPHERAL)
#define BLE_L2CM 0
#define BLE_L2CC 0
#define BLE_ATTC 0
...
#define BLE_TAG_GATTC_HEAP_ENV_SIZE (0)
#define BLE_TAG_L2CC_HEAP_ENV_SIZE (0)
#endif //(BLE_CENTRAL || BLE_PERIPHERAL)
...
/* --------------------------   PROFILES          ----------------------------------------*/
/******************************************************************************************/
#if defined(CFG_PRF) && !defined(CFG_WM_HCI) && !defined(CFG_PWR_PROFILING)
...
#define GAP_DB_SIZE (52)
#define GATT_DB_SIZE (42)
#ifdef MBED_PORT
#define BLEHL_HEAP_DB_SIZE (GAP_DB_SIZE + GATT_DB_SIZE + 4096)
#else
#define BLEHL_HEAP_DB_SIZE (GAP_DB_SIZE + GATT_DB_SIZE + BLE_PRF_DB_SIZE)
#endif
...
#define BLEHL_HEAP_ENV_SIZE (BLE_GAPC_HEAP_ENV_SIZE + BLE_GATTC_HEAP_ENV_SIZE + BLE_L2CC_HEAP_ENV_SIZE)

#define BLEHL_TAG_HEAP_ENV_SIZE (BLE_TAG_GAPC_HEAP_ENV_SIZE + BLE_TAG_GATTC_HEAP_ENV_SIZE + BLE_TAG_L2CC_HEAP_ENV_SIZE)
...
#define CFG_GAP_TMR_LIM_ADV_TIMEOUT 0x4650
#define GAP_TMR_LIM_ADV_TIMEOUT (ble_config.fw->gap_tmr_lim_adv_timeout)
...
/// recommended value: 0x384 15 minutes; 0x05 for PTS, 0x0F:15s for wvt test script
/// 0x96 is 150 seconds; 0x258 is 10 minutes
#define GAP_TMR_PRIV_ADDR_INT 0x05
...
#define CFG_GAP_MAX_LE_MTU (2048)
#define GAP_MAX_LE_MTU (ble_config.fw->gap_max_le_mtu)

/// Maximum GAP device name size
#define GAP_MAX_NAME_SIZE (248)

/// Maximum Transmission Unit
#define ATT_DEFAULT_MTU (23)
/// 30 seconds transaction timer
#define CFG_ATT_TRANS_RTX (0x0BB8)
#define ATT_TRANS_RTX (ble_config.fw->att_trans_rtx)
/// Acceptable encryption key size - strict access
#define ATT_SEC_ENC_KEY_SIZE (0x10)

/// Maximum attribute value length
#define ATT_MAX_VALUE (512)
