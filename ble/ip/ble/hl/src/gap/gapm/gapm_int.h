...
/// Scan filter size
#define CFG_GAPM_SCAN_FILTER_SIZE                    10
#define GAPM_SCAN_FILTER_SIZE                        (ble_config.fw->gapm_scan_filter_size)
 ...
 ****************************************************************************************
 */
__FORCEINLINE void* gapm_get_operation_ptr(uint8_t op_type)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void gapm_set_operation_ptr(uint8_t op_type, void* op)
{
    ASSERT_ERR(op_type < GAPM_OP_MAX);
