...
#define GAPM_IS_ROLE_SUPPORTED(role_type) ((gapm_env.role & (role_type)) == (role_type))

/// Get current operation state
#define GAPM_GET_OP_STATE(operation) ((operation).state & (GAPM_OP_MASK))
...
#define GAPM_IS_OP_FIELD_SET(operation, field) ((((operation).state) & (GAPM_OP_##field##_MASK)) != 0)

/// Set operation in kernel queue
#define GAPM_SET_OP_FIELD(operation, field) ((operation).state) |= (GAPM_OP_##field##_MASK)

/// Clear operation in kernel queue
#define GAPM_CLEAR_OP_FIELD(operation, field) ((operation).state) &= ~(GAPM_OP_##field##_MASK)
