 ...
 ****************************************************************************************
 */
void l2cc_lecb_send_con_req(
    uint8_t conidx, uint8_t pkt_id, uint16_t le_psm, uint16_t scid, uint16_t credits, uint16_t mps, uint16_t mtu);
 ...
 ****************************************************************************************
 */
void l2cc_lecb_send_con_rsp(
    uint8_t conidx, uint16_t status, uint8_t pkt_id, uint16_t dcid, uint16_t credits, uint16_t mps, uint16_t mtu);
