...
#define GATT_OPERATION_CMD(conidx, op_type, cmd) ((struct cmd *)gattc_get_operation_ptr(conidx, op_type))

#define GATT_WRITE_ERROR_CODE (0xFFFF)

/// number of GATT Controller Process
#define GATTC_IDX_MAX FW_BLE_CONNECTION_MAX
 ...
 ****************************************************************************************
 */
void gattc_send_error_evt(
    uint8_t conidx, uint8_t operation, uint16_t seq_num, const ke_task_id_t requester, uint8_t status);
