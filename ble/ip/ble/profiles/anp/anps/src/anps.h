...
#define ANPS_IS_NEW_ALERT_CATEGORY_SUPPORTED(category_id) (((anps_env->supp_new_alert_cat >> category_id) & 1) == 1)

#define ANPS_IS_UNREAD_ALERT_CATEGORY_SUPPORTED(category_id) \
    (((anps_env->supp_unread_alert_cat >> category_id) & 1) == 1)

#define ANPS_IS_ALERT_ENABLED(conidx, idx_env, alert_type) (((idx_env->env[conidx]->ntf_cfg >> alert_type) & 1) == 1)
...
#define ANPS_ENABLE_ALERT(conidx, idx_env, alert_type) (idx_env->env[conidx]->ntf_cfg |= (1 << alert_type))

#define ANPS_DISABLE_ALERT(conidx, idx_env, alert_type) (idx_env->env[conidx]->ntf_cfg &= ~(1 << alert_type))
