...
#define DBG_SWDIAG(bank, field, value)                                                                                 \
    ...
    {                                                                                                                  \
        SW_DIAG_SET(((SW_DIAG_GET()) & (~(DBG_SWDIAG_##bank##_##field##_MASK << (8 * sw_to_hw[DBG_SWDIAG_##bank])))) | \
                    ((((value << DBG_SWDIAG_##bank##_##field##_OFFSET) & DBG_SWDIAG_##bank##_##field##_MASK)           \
                      << (8 * sw_to_hw[DBG_SWDIAG_##bank]))));                                                         \
    }
...
enum dbg_swdiag
{
    ...
    */
    ...
    DBG_SWDIAG_SLEEP_ALGO_OFFSET = 1,
    DBG_SWDIAG_SLEEP_ALGO_MASK = 0x0E,
    ...
    */
    ...
    DBG_SWDIAG_BLE_ISR_CSCNTINT_OFFSET = 0,
    DBG_SWDIAG_BLE_ISR_CSCNTINT_MASK = 0x01,

    DBG_SWDIAG_BLE_ISR_RXINT_OFFSET = 1,
    DBG_SWDIAG_BLE_ISR_RXINT_MASK = 0x02,

    DBG_SWDIAG_BLE_ISR_SLPINT_OFFSET = 2,
    DBG_SWDIAG_BLE_ISR_SLPINT_MASK = 0x04,

    DBG_SWDIAG_BLE_ISR_EVENTINT_OFFSET = 3,
    DBG_SWDIAG_BLE_ISR_EVENTINT_MASK = 0x08,

    DBG_SWDIAG_BLE_ISR_CRYPTINT_OFFSET = 4,
    DBG_SWDIAG_BLE_ISR_CRYPTINT_MASK = 0x10,

    DBG_SWDIAG_BLE_ISR_ERRORINT_OFFSET = 5,
    DBG_SWDIAG_BLE_ISR_ERRORINT_MASK = 0x20,

    DBG_SWDIAG_BLE_ISR_GROSSTGTIMINT_OFFSET = 6,
    DBG_SWDIAG_BLE_ISR_GROSSTGTIMINT_MASK = 0x40,

    DBG_SWDIAG_BLE_ISR_FINETGTIMINT_OFFSET = 7,
    DBG_SWDIAG_BLE_ISR_FINETGTIMINT_MASK = 0x80,
    ...
    */
    ...
    /**
    ******************************************************************************************
    * @brief BANK 3 : BLEISR - 2
    ******************************************************************************************
    */
    DBG_SWDIAG_BLE_ISR2 = 26,

    DBG_SWDIAG_BLE_ISR2_SWINT_OFFSET = 0,
    DBG_SWDIAG_BLE_ISR2_SWINT_MASK = 0x01,

    DBG_SWDIAG_BLE_ISR2_EVENTAPFMINT_OFFSET = 1,
    DBG_SWDIAG_BLE_ISR2_EVENTAPFMINT_MASK = 0x02,

    DBG_SWDIAG_BLE_ISR2_AUDIO0INT_OFFSET = 2,
    DBG_SWDIAG_BLE_ISR2_AUDIO0INT_MASK = 0x04,

    DBG_SWDIAG_BLE_ISR2_AUDIO1INT_OFFSET = 3,
    DBG_SWDIAG_BLE_ISR2_AUDIO1INT_MASK = 0x08,

    DBG_SWDIAG_BLE_ISR2_AUDIO2INT_OFFSET = 4,
    DBG_SWDIAG_BLE_ISR2_AUDIO2INT_MASK = 0x10,
    ...
    */
    ...
    /**
     ******************************************************************************************
     * @brief BANK 29 : ACL_TX
     ******************************************************************************************
     */
    DBG_SWDIAG_ACL_TX = 29,
    ...
    /**
     ******************************************************************************************
     * @brief BANK 30 : ACL_RX
     ******************************************************************************************
     */
    DBG_SWDIAG_ACL_RX = 30,
