...
enum TASK_API_ID
{
    ...
    TASK_ID_QPPS = 61, // QBLUE private profile server task
    TASK_ID_QPPC = 62, // QBLUE private profile client task

    TASK_ID_YELLS = 63, // YELL profile server task
    TASK_ID_OTAC = 64, // OTA profile server task
    TASK_ID_OTAS = 65, // OTA profile client task
