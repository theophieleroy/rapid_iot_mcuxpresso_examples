 ...
 ****************************************************************************************
 */
__FORCEINLINE void ke_queue_push(struct co_list *const queue, struct co_list_hdr *const element)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE struct co_list_hdr *ke_queue_pop(struct co_list *const queue)
{
 ...
 ****************************************************************************************
 */
void ke_queue_insert(struct co_list *const queue,
