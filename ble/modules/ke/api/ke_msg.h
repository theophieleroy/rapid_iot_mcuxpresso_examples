...
/// Connection index to connection hanle
#define CONIDX2CONHDL(idx) ((uint16_t)(idx))
/// Connection hanle to connection index
#define CONHDL2CONIDX(hdl) ((uint8_t)(hdl))
 ...
 ****************************************************************************************
 */
__FORCEINLINE struct ke_msg *ke_param2msg(void const *param_ptr)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void *ke_msg2param(struct ke_msg const *msg)
{
...
#define KE_MSG_ALLOC_DYN(id, dest, src, param_str, length) \
    (struct param_str *) ke_msg_alloc(id, dest, src, (sizeof(struct param_str) + (length)));
