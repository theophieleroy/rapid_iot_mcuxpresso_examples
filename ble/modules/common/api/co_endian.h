 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_bswap32(uint32_t val32)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_bswap16(uint16_t val16)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_htonl(uint32_t hostlong)
{
    #if (!CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_htons(uint16_t hostshort)
{
    #if (!CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_ntohl(uint32_t netlong)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_ntohs(uint16_t netshort)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_htobl(uint32_t hostlong)
{
    #if (CPU_LE)
        return hostlong;
    #else
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_htobs(uint16_t hostshort)
{
    #if (CPU_LE)
        return hostshort;
    #else
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_btohl(uint32_t btlong)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_btohs(uint16_t btshort)
{
