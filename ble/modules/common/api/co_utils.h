...
#define LMP_MSG_HANDLER(msg_name) \
    __STATIC int lmp_##msg_name##_handler(struct lmp_##msg_name const *param, ke_task_id_t const dest_id)

/// Macro for HCI message handler function declaration or definition (for multi-instanciated tasks)
#define HCI_CMD_HANDLER_C(cmd_name, param_struct) \
    __STATIC int hci_##cmd_name##_cmd_handler(param_struct const *param, ke_task_id_t const dest_id, uint16_t opcode)

/// Macro for HCI message handler function declaration or definition (with parameters)
#define HCI_CMD_HANDLER(cmd_name, param_struct) \
    __STATIC int hci_##cmd_name##_cmd_handler(param_struct const *param, uint16_t opcode)
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_read32(void const *ptr32)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint16_t co_read16(void const *ptr16)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write32(void const *ptr32, uint32_t value)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write16(void const *ptr16, uint32_t value)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write8(void const *ptr8, uint32_t value)
{
    *(uint8_t *)ptr8 = value;
}
 ...
 ****************************************************************************************
 */
__FORCEINLINE uint32_t co_read24p(void const *ptr24)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write24p(void const *ptr24, uint32_t value)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write32p(void const *ptr32, uint32_t value)
{
 ...
 ****************************************************************************************
 */
__FORCEINLINE void co_write16p(void const *ptr16, uint16_t value)
{
